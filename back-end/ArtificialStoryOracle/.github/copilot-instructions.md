# Instruções do Copilot para o repositório ArtificialStoryOracle
...
## Prioridade
1. Siga as regras definidas neste arquivo e em `.github/copilot-instructions.md` (este arquivo).\
...
Última atualização: automático pelo Copilot local. Use este arquivo como referência durante sessões de pair programming.
