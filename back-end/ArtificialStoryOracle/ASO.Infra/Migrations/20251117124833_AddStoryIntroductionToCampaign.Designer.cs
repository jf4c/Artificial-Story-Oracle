...
namespace ASO.Infra.Migrations
{
    ...
    [Migration("20251117124833_AddStoryIntroductionToCampaign")]
    partial class AddStoryIntroductionToCampaign
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASO.Domain.Game.Entities.Campaign", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("ASO.Domain.Game.Entities.CampaignParticipant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("campaign_participants", (string)null);
                });
            ...
            modelBuilder.Entity("ASO.Domain.Game.Entities.Campaign", b =>
                {
                    b.HasOne("ASO.Domain.Game.Entities.Player", "Creator")
                    ...
                    b.HasOne("ASO.Domain.Game.Entities.Player", "GameMaster")
            ...
            modelBuilder.Entity("ASO.Domain.Game.Entities.CampaignParticipant", b =>
                {
                    b.HasOne("ASO.Domain.Game.Entities.Campaign", "Campaign")
                        .WithMany("Participants")
                        .HasForeignKey("CampaignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASO.Domain.Game.Entities.Character", "Character")
                        .WithMany("CampaignParticipations")
                        .HasForeignKey("CharacterId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("ASO.Domain.Game.Entities.Player", "Player")
                        .WithMany("CampaignParticipations")
                    ...
                    b.OwnsOne("ASO.Domain.Shared.ValueObjects.Tracker", "Tracker", b1 =>
                        {
                            b1.Property<Guid>("CampaignParticipantId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("CampaignParticipantId");

                            b1.ToTable("campaign_participants");
